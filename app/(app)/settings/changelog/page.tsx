...
const DEFAULT_NEWS = `🌿 Що нового в Лаванді

📸 Календар фотосесій став розумнішим

☀️ Погода прямо в календарі
• Прогноз погоди й час сходу/заходу сонця на сторінці «Фотосесії»
• На міні-календарі кожен день має іконку погоди (☀️ ⛅ ☁️ 🌧️) — одразу видно, де очікується дощ

🌅 Найкраще світло для зйомки
• Календар підсвічує кольором найкращі години: «золота година» зранку та ввечері, «синя година» на заході
• Враховано реальне розташування поля «Kvita» відносно сходу й заходу сонця

⏰ Погодинний прогноз
• Температура, хмарність та опади по годинах — плануйте сеанс під ідеальне світло

🔀 Два режими перегляду
• Перемикач «Календар / Слоти»: таймлайн дня або список рекомендованих слотів із рейтингом ⭐ та фільтрами (Фото / Відео / Схід / Захід)

📱 Зручніше на телефоні
• Оновлено мобільний вигляд — погода, фази світла й записи компактні та читабельні

✅ Минулі сеанси автоматично позначаються як «Завершено»
