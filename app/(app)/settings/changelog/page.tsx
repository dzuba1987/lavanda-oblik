...
💳 Оплата замовлень
• У замовленні тепер є статус оплати та спосіб: готівка або картка
• У списку сума підсвічується кольором: зелена — оплачено, бурштинова — ще ні, поряд — іконка способу
• Позначити оплату (або зняти) можна одним кліком прямо зі списку
• Завершені замовлення автоматично вважаються оплаченими

🗓 Дати й час
• На картці замовлення видно дату й час створення
• Дедлайн («до коли») показується окремо, щоб не плутати

🚚 Доставка
• Дату доставки та спосіб обʼєднано в один зручний блок
